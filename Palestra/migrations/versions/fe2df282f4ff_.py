...
Revision ID: fe2df282f4ff
Revises: a0430b6617fb
Create Date: 2021-05-04 18:02:38.747934
...
revision = 'fe2df282f4ff'
down_revision = 'a0430b6617fb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.CheckConstraint('slot.oraFine > slot.oraInizio'),
