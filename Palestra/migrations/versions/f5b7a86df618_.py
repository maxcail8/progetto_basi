...
Revision ID: f5b7a86df618
Revises: 543db671c26a
Create Date: 2021-05-04 17:52:29.262554
...
revision = 'f5b7a86df618'
down_revision = '543db671c26a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('oraInizio', sa.Time(), nullable=True),
    sa.Column('oraFine', sa.Time(), nullable=True),
